...
def _make_rope_config(base_config, use_base_rope: bool):
    """
    生成 RoPE 初始化所用的临时配置。
    - use_base_rope=True  : 直接沿用 base_config 中的 max_position_embeddings 与 rope_theta（用于 FuseDiT 适配 LLM 原生 RoPE）
    - use_base_rope=False : 按默认规则固定为 theta=10000、max_position_embeddings=4096
    """
